...
const TABS: LearnTab[] = [
  {
    ...
    meta: "20+ guides",
    featured:
      "From your first scan to a finished crown — every step documented.",
    items: [
      "Scanner setup & calibration",
      "Chairside design basics",
  ...
  },
  {
    ...
    items: [
      "Digital restorative fundamentals",
          ...
          <div className="lt-list">
            ...
            <ul>
              {displayTab.items.map((item, i) => (
                <li key={item} style={{ "--lt-i": i } as React.CSSProperties}>
                  {item}
                </li>
              ))}
            </ul>
