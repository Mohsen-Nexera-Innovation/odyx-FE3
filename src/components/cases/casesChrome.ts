...
export const CASES_BTN_BASE =
  'inline-flex items-center justify-center gap-2 text-[13px] lg:text-[14px] font-semibold leading-none [line-height:1] [text-box:trim-both_cap_alphabetic] px-5 py-2.5 rounded-full transition-colors [&_svg]:block [&_svg]:size-[1em] [&_svg]:shrink-0';
