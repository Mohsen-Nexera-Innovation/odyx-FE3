...
const STEPS: EStep[] = [
  { no: '01', label: 'Scan', product: 'ODYX-S1', accent: 'teal', video: '/video/hero.mp4', poster: '/img/scanner/s1-hero.png', cap: 'A chairside ODYX-S1 scan captures the mouth in seconds - no molds, just instant, accurate 3D data.' },
  ...
  { no: '04', label: 'Cure', product: 'ODYX Cure', accent: 'orange', video: '/video/dental-scan-animation.mp4', poster: '/img/cure-uv02/hero/machine-cutout.png', cap: 'Controlled curing on ODYX Cure completes polymerization for full strength and biocompatibility.' },
