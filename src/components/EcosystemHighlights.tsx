...
const STEPS: EStep[] = [
  { no: '01', label: 'Scan', product: 'ODYX-S1', accent: 'teal', video: '/video/hero.mp4', poster: '/img/feat-scanner.png', cap: 'A chairside ODYX-S1 scan captures the mouth in seconds - no molds, just instant, accurate 3D data.' },
