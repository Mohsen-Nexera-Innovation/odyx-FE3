        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-4 lg:gap-6 items-start">
          <div className="flex flex-col gap-4 lg:gap-6">
                ...
                <table className="w-full min-w-[320px] border-collapse text-left">
                  <thead>
                    <tr className="border-b border-[#E5E7EB]">
                      <th className="py-4 pr-5 text-[13px] font-bold text-[#6B7280]">Product</th>
                      <th className="py-4 text-[13px] font-bold text-[#6B7280]">
                        Warranty Period
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {WARRANTY_PERIODS.map((row, i) => (
                      <tr key={row.product} className={i !== WARRANTY_PERIODS.length - 1 ? 'border-b border-[#F1F2F4]' : ''}>
                        <td className="py-4 pr-5 text-[13px] font-bold text-[#0A1020]">{row.product}</td>
                        <td className="py-4 text-[13px] font-semibold text-[#0A1020]">{row.period}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div className="flex flex-col rounded-[12px] border border-[#E5E7EB] bg-[#F9FAFB] p-5 sm:p-6">
              <h3 className="text-[15px] font-bold text-[#0A1020]">Need help?</h3>
              <p className="mt-2 text-[13px] leading-relaxed font-medium text-[#6B7280]">
                Contact our support team for<br />assistance with your warranty claim.
              </p>
              <div className="mt-5">
                <a
                  href="/sales"
                  className="inline-flex h-[38px] items-center justify-center rounded-[8px] border border-[#0050D8]/20 bg-white px-6 text-[13px] font-bold !text-[#0050D8] transition-colors hover:bg-[#F3F7FF] hover:border-[#0050D8]/40"
                >
                  Contact Support
                </a>
              </div>
