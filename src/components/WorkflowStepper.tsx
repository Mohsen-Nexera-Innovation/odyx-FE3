...
const STEPS: WStep[] = [
  ...
  { no: '04', label: 'Cure', product: 'ODYX Cure', desc: 'Controlled UV on ODYX Cure completes polymerization for full strength and biocompatibility.', img: '/img/cure-uv02/hero/machine-cutout.png', accent: 'orange', brand: BRAND_PRINTING },
