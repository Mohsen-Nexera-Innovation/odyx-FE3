...
const CHANNELS: SupportChannel[] = [
  ...
  },
  {
    ...
    meta: 'Online',
    detail: 'AI-guided support with escalation to a live specialist when needed.',
  ...
  },
  {
    ...
    meta: 'Self-service',
    detail: 'Searchable knowledge base with device manuals and video tutorials.',
...
const ICONS: Record<ChannelId, React.ReactNode> = {
  whats: (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 21l1.6-4.5A8 8 0 1 1 8 19.4z" /><path d="M9 9c0 3 3 6 6 6l1.5-1.5-2-1.5-1 1c-1-.5-2-1.5-2.5-2.5l1-1L10.5 8z" />
    </svg>
  ),
  chat: (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 4h16v12H8l-4 4z" /><path d="M8 9h8M8 12h5" />
    </svg>
  ),
  doc: (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <div className="sh-wrap m-up">
      <div className="sh-live">
        ...
        <p>Reach our team instantly through WhatsApp or start a guided chat with Odyx Agent.</p>
