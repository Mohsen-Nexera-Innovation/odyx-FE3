...
export default function CureVideo() {
  return (
    <div className="reveal flex h-auto min-h-[334px] flex-col rounded-[18px] border-4 border-solid border-white bg-transparent p-[clamp(16px,1.8vw,22px)]">
      ...
      >
        {CURE_UV02_VIDEO.title}
      </h2>
      <div className="relative min-h-[180px] w-full flex-[1_1_auto] overflow-hidden rounded-xl bg-[#1a2433] aspect-video max-h-[240px] max-[800px]:max-h-none max-[800px]:min-h-[180px] max-[800px]:w-full">
