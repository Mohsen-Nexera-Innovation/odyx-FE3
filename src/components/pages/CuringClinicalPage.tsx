...
const PILLARS = [
  ...
  },
  {
    ...
    title: "Measured heat",
    metric: "≤45°C",
    image: "/img/cure-stitch/odyx-dualwave-engine.webp",
  },
  {
...
const STORIES = [
  {
    ...
    metric: "360°",
    image: "/img/cure-stitch/odyx-360-curing.webp",
    alt: "Cobalt light rings surrounding a dental restoration inside the curing chamber",
  },
  {
    id: "dualwave",
    title: "UV bands",
    metric: "2λ",
    image: "/img/cure-stitch/odyx-dualwave-engine.webp",
    alt: "Dental appliances illuminated by the dual-wavelength curing engine",
  },
  {
    id: "thermo",
    title: "Regulated chamber",
    metric: "≤45°C",
    image: "/img/cure-stitch/odyx-cured-appliances.webp",
    alt: "Collection of professionally cured dental appliances",
  },
] as const;

const INDICATIONS = [
  { name: "Crowns & Bridges", time: "3–5 min", image: "/img/cure-stitch/odyx-cine-crown.webp" },
  { name: "Surgical Guides", time: "3 min", image: "/img/cure-stitch/odyx-cine-guide.webp" },
  { name: "Denture Bases", time: "8–10 min", image: "/img/cure-stitch/odyx-cine-denture.webp" },
  { name: "Dental Models", time: "2 min", image: "/img/cure-stitch/odyx-cine-model.webp" },
  { name: "Splints & Guards", time: "4 min", image: "/img/cure-stitch/odyx-cine-guard.webp" },
  { name: "Provisionals", time: "3 min", image: "/img/cure-stitch/odyx-cine-temp.webp" },
] as const;
...
const WORKFLOW = [
  ...
  {
    label: "Cure",
    image: "/img/cure-stitch/machine-hero.png",
    alt: "ODYX Cure UV-02",
    active: true,
  },
] as const;
...
export default function CuringClinicalPage() {
  return (
    <div className="cure-page">
      <section className="cure-hero" id="cure-hero">
        ...
        <div className="cure-wrap cure-hero__content m-stagger">
          ...
          <Link className="cure-version-link" href="/products/curing-machines/cutout">
            View cutout version
      ...
      <section className="cure-indications" id="cure-applications">
        <div className="cure-wrap">
          ...
          <div className="cure-indications__feature m-scale">
            <img
              src="/img/cure-stitch/odyx-cine-clinical-grid.webp"
              alt="Crown, surgical guide, denture base and clear dental guard in cinematic light"
              width={1024}
              height={1024}
            />
