...
export const WORKFLOW_STEPS: WorkflowStepContent[] = [
  {
    ...
    benefits: [
      ...
      "Open export to CAD",
      "Patient comfort and speed",
    ],
    dentistNote:
      "Ideal for same-day starts: scan once, design and print without sending a case out.",
    labNote:
      "Receive clean STL/PLY from clinics or pair with a desktop lab scanner for high-volume intake.",
    learning: [
  ...
  },
  {
    ...
    benefits: [
      "Validated design libraries",
      "Repeatable margins and contacts",
      "Export ready for print",
      "Dentist and lab workflows",
    ],
    dentistNote:
      "Chairside design paths keep the patient in the chair while the restoration is prepared.",
    labNote:
      "Batch design and nesting for production runs with consistent parameters.",
    learning: [
  ...
  },
  {
    ...
    dentistNote:
      "Print provisionals or finals chairside while the patient waits.",
  ...
  },
  {
    ...
    lead: "Controlled polymerization for full strength and biocompatibility.",
    whatHappens:
  ...
  },
  {
    ...
    benefits: [
      ...
      "Lab-grade characterization",
    ],
    dentistNote:
      "Same-day cases can use pre-shaded Resin; customize when aesthetics demand it.",
