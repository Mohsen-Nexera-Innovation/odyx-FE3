  ...
  cases: [
    {
      ...
      imgAlt: 'Clinical case — printed dental models',
      href: '/solutions/clinical-applications',
    },
    {
      id: 'case-2',
      img: '/img/hv2-clinical/dental-models.webp',
      imgAlt: 'Clinical case — diagnostic arch models',
      href: '/solutions/clinical-applications',
    },
    {
      id: 'case-3',
      img: '/img/printers/p126/case-printed.png',
      imgAlt: 'Clinical case — printed restorations on the build plate',
      href: '/solutions/clinical-applications',
    },
    {
      id: 'case-4',
      img: '/img/printers/p126/case-crown-strip.png',
      imgAlt: 'Clinical case — finished model-supported restorations',
      href: '/solutions/clinical-applications',
    },
  ],
