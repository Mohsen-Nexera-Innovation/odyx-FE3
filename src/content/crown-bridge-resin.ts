...
export const CROWN_BRIDGE_RESIN_CONTENT: ResinDetailContent = {
  ...
  cases: [
    {
      id: 'case-1',
      img: '/images/case-cb-1.jpg',
      imgAlt: 'Clinical case — crown and bridge result',
      href: '/solutions/clinical-applications',
    },
    {
      id: 'case-2',
      img: '/images/case-cb-2.jpg',
      imgAlt: 'Clinical case — seated restorations',
      href: '/solutions/clinical-applications',
    },
    {
      id: 'case-3',
      img: '/images/case-cb-3.jpg',
      imgAlt: 'Clinical case — anterior units',
      href: '/solutions/clinical-applications',
    },
    {
      id: 'case-4',
      img: '/images/case-cb-4.jpg',
      imgAlt: 'Clinical case — posterior bridge',
      href: '/solutions/clinical-applications',
    },
  ],
