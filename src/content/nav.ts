...
export const HEADER_MENUS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '3D Printers — Signature', href: '/products/3d-printers' },
      { label: '3D Printers — Cinematic', href: '/products/3d-printers-cinematic' },
      { label: '3D Printers — Classic', href: '/products/3d-printers-classic' },
