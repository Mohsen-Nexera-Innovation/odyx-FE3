export interface SolutionPath {
  ...
  accent: 'teal' | 'orange';
  challenges: string[];
  recommendedProducts: { name: string; href: string; why: string; img: string }[];
...
export const SOLUTION_PATHS: SolutionPath[] = [
  {
    ...
    recommendedProducts: [
      { name: 'Intraoral Scanner', href: '/products/intraoral-scanner', why: 'Start digital with chairside scans', img: '/img/feat-scanner.jpg' },
      { name: 'Design Software', href: '/products/design', why: 'Design crowns and guides in-house', img: '/img/odyx/design.webp' },
      { name: '3D Printer', href: '/products/3d-printers', why: 'Print provisionals and finals same-day', img: '/img/feat-printer.jpg' },
      { name: 'Curing Machine', href: '/products/curing-machines', why: 'Validated cure for safe delivery', img: '/img/feat-curing.jpg' },
      { name: 'Clinical Resins', href: '/products/resins', why: 'Materials matched to each indication', img: '/img/feat-resin.jpg' },
    ],
    workflowEmphasis: ['Scan chairside', 'Design while patient waits', 'Print & cure in-clinic', 'Deliver same visit'],
    outcomes: [
