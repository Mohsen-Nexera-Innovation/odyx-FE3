      ...
      messages: [
        {
          ...
          subject: 'Scan upload — Single Unit #14 (PT-204)',
        ...
        },
        {
          ...
          to: email,
          toLabel: name,
          subject: 'Re: Scan upload — Single Unit #14 (PT-204)',
      ...
      messages: [
        {
          ...
          to: DESIGN_TEAM_EMAIL,
          toLabel: 'ODYX Design Team',
          subject: 'Scan upload — Digital Smile Design (Veneers)',
          body: 'Smile design / veneer case for upper anteriors.',
        ...
        },
        {
          ...
          to: email,
          toLabel: name,
          subject: 'Re: Scan upload — Digital Smile Design (Veneers)',
          body: 'Design package attached. Ready for your print workflow.',
          attachments: [{ id: 's3b-f', name: 'veneer_design_pack.zip', size: 3_200_000, kind: 'design' }],
          at: hoursAgo(72),
          read: true,
        },
      ],
      ...
      messages: [
        {
          ...
          to: DESIGN_TEAM_EMAIL,
          toLabel: 'ODYX Design Team',
          subject: 'Scan upload — Occlusal Splint (BATCH-04)',
          body: 'Full arch scan for occlusal splint design.',
        ...
        },
        {
          ...
          to: email,
          toLabel: name,
          subject: 'Re: Scan upload — Occlusal Splint (BATCH-04)',
          body: 'Splint design ready for print.',
          attachments: [{ id: 'l2b-f', name: 'splint_design.stl', size: 2_400_000, kind: 'design' }],
          at: hoursAgo(4),
          read: false,
        },
      ],
