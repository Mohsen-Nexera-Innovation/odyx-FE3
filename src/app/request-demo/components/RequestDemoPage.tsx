...
const INITIAL: DemoFormState = {
  firstName: 'Mohsen',
  lastName: 'Suad',
  email: 'name@clinic.com',
  phone: '+20 101 234 5678',
  country: 'Egypt',
  city: 'Cairo',
  language: 'en',
  role: 'dentist',
  clinicName: 'Clear Smile Dental Clinic',
  chairs: '4-6 Chairs',
  specialty: 'Restorative Dentistry',
  products: ['scanner', 'design', 'printer', 'cure', 'resins', 'workflow'],
  applications: ['crown-bridge', 'implant', 'surgical-guide', 'general'],
  demoType: 'online',
  date: '2025-05-28',
  time: '03:00 PM',
