...
| --- | --- | --- | --- |
| **develop** | Hostinger VPS Docker | `develop` | web `:3002`, API `:4002` |
| **staging** | Hostinger VPS Docker (also optional Vercel FE) | `staging` | web `:3000`, API `:4000` |
...
GitHub Actions deploys **develop**, **staging**, and **production** from the matching git branches. Same secrets: `VPS_HOST`, `VPS_USER`, `VPS_SSH_KEY`, `VPS_SSH_PORT`, `VPS_DEPLOY_PATH=/opt/odyx/api`.
